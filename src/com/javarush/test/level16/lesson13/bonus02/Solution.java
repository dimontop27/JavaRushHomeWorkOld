...
public class Solution {
    ...
    public static class eternityThread extends Thread {
        public void run() {
            try {
                while (true) {
                    this.sleep(10);
   ...
   public static class summaThread extends Thread {
        public void run() {
            try {
